...
touch dist/server.bat
echo 'start bin/SimpleServer.exe  --cwd=%cd%/' > dist/server.bat

touch dist/client.bat
echo 'start bin/SimpleEngine.exe  --cwd=%cd%/ --host=127.0.0.1 --port=45000 --dbg_port=9600 --user=oceancx --pass=123456' > dist/client.bat
