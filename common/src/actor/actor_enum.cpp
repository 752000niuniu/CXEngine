...
//ENUM_ACTOR_PROP
	...
	REG_ENUM(PROP_DAMAGE_DELTA);
	REG_ENUM(PROP_DEFEND_DELTA);
	REG_ENUM(PROP_SPEED_DELTA);
	REG_ENUM(PROP_SPIRITUAL_DELTA);
	REG_ENUM(PROP_TARGETHIT_DELTA);
	REG_ENUM(PROP_DODGE_DELTA);
	REG_ENUM(PROP_COUNT);
